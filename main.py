...
class App(QWidget):
    ...
    def resizeEvent(self, a0: QtGui.QResizeEvent) -> None:
        ...
        self.ui.gui_widgets['idioma_menu'].move(width - 316, 8)
        self.ui.gui_widgets['tema_switch_light'].move(width - 236, 8)
        self.ui.gui_widgets['tema_switch_dark'].move(width - 210, 8)
        ...
        self.ui.gui_widgets['aboutQt_button'].move(width - 56, 8)

        self.ui.gui_widgets['somatotype_plot_card'].setGeometry(196, 64, width - 636, int(height * 0.75))
        self.ui.gui_widgets['somatotype_plot_card'].title.resize(width - 652, 32)
        self.ui.gui_widgets['somatotype_plot'].setGeometry(8, 48, self.ui.gui_widgets['somatotype_plot_card'].width()-16, self.ui.gui_widgets['somatotype_plot_card'].height()-56)
        
        self.ui.gui_widgets['endomorph_card'].setGeometry(width - 432, 64, 208, 288)
        self.ui.gui_widgets['mesomorph_card'].setGeometry(width - 216, 64, 208, 468)
        self.ui.gui_widgets['ectomorph_card'].setGeometry(width - 432, 360, 208, 108)
